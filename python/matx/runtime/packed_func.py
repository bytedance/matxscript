...
class PackedFunc(PackedFuncBase):
    ...
    Function plays an key role to bridge front and backend in MATX.
    ...
    MATX backend also registers and exposes its API as Functions.
    ...
    See Also
    --------
    matx.register_func: How to register global function.
    matx.get_global_func: How to get global function.
    """
