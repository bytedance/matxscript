...
class _GaussianBlurOpImpl:
    ...
    def __init__(self,
        ...
        self.op: matx.NativeObject = make_native_object(
            "VisionGaussianBlurGeneralOp", device())
    ...
    def __call__(self,
        ...
        assert len(
            ksizes) == batch_size, "The ksize number for gaussian blur should be equal to batch size."
        assert len(
            sigmas) == batch_size, "The sigma number for gaussian blur should be equal to batch size."

        return self.op.process(images, ksizes, sigmas, self.pad_type, sync)
...
class GaussianBlurOp:
    ...
    def __init__(self,
        ...
        """
        self.op: _GaussianBlurOpImpl = matx.script(_GaussianBlurOpImpl)(device, pad_type)
    ...
    def __call__(self,
        ...
        """
        return self.op(images, ksizes, sigmas, sync)
