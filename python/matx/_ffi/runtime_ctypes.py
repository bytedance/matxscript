...
matx_shape_index_t = ctypes.c_int64
...
class MATXByteArray(ctypes.Structure):
...
class MATXArray(ctypes.Structure):
    ...
    _fields_ = [("data", ctypes.c_void_p),
                ...
                ("strides", ctypes.POINTER(matx_shape_index_t)),
...
MATXArrayHandle = ctypes.POINTER(MATXArray)
MATXTensorHandle = ctypes.POINTER(MATXArray)
