...
from matx.vision.tv_transforms import Compose, GaussianBlur
...
class TestGaussianBlur(unittest.TestCase):
    ...
    def test_gaussian_blur_with_compose(self):
        ...
        torchvision_op = transforms.GaussianBlur(3, 1)
    ...
    def test_scripted_gaussian_blur_with_compose(self):
        op = matx.script(GaussianBlur)([3], [1])
